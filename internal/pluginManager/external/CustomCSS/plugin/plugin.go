// internal/pluginManager/external/CustomCSS/plugin/plugin.go
package plugin
...
import (
    ...
    "knovault/internal/pluginManager/external/CustomCSS/templates"
)
...
func NewCustomCSSPlugin() *CustomCSSPlugin {
...
func (p *CustomCSSPlugin) Help() string {
    return "Use this plugin to view, edit, and apply custom CSS styles. Your styles will override default styles."
}
