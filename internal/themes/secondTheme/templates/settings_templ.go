...
func Settings() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div><h1 class=\"mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white\">Settings</h1><h2 class=\"mb-4 text-xl font-bold\">Hello World Plugin Output:</h2>")
			if templ_7745c5c3_Err != nil {
			...
			if plugin, ok := plugins.GetPlugin("HelloWorld"); ok {
				if response, err := plugin.TemplResponse(); err == nil {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/themes/secondTheme/templates/settings.templ`, Line: 16, Col: 65}
					}
			...
			if plugin, ok := plugins.GetPlugin("ThemeChanger"); ok {
				if response, err := plugin.TemplResponse(); err == nil {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/themes/secondTheme/templates/settings.templ`, Line: 27, Col: 65}
					}
